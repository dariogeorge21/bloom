...
export const faqData = {
  ...
  ml: [
    ...
    },
    {
      ...
      answer: "ഈ ഇവന്റ് താബോർ ആശ്രമം കൊടുമ്പിടി, പാല, കോട്ടയം, കേരളം, ഇന്ത്യയിൽ നടക്കുന്നു. ഞങ്ങളുടെ വെബ്സൈറ്റിലെ 'കുറിച്ച്' വിഭാഗത്തിൽ നിങ്ങൾക്ക് ദിശാനിർദ്ദേശങ്ങൾ കാണാം."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      answer: "നിങ്ങൾക്ക് ഞങ്ങളുടെ ഇവന്റ് കോർഡിനേറ്റർമാരെ ബന്ധപ്പെടാം: ആന്റോ (62825 86348) അല്ലെങ്കിൽ നെയ്മോൾ (85908 15612)."
    }
  ]
};
...
export const chatbotUI = {
  ...
  ml: {
    ...
    poweredBy: "ജീസസ് യൂത്ത് പാല നൽകുന്നത്"
  }
};
